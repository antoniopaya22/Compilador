...
public abstract class AbstractCGVisitor implements Visitor{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see visitor.Visitor#visit(ast.expresion.Ternario, java.lang.Object)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see visitor.Visitor#visit(ast.sentencia.DoWhile, java.lang.Object)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see visitor.Visitor#visit(ast.sentencia.For, java.lang.Object)
	 */
	@Override
	public Object visit(For e, Object param) {
		throw new IllegalStateException("Esta plantilla no se puede aplicar a For");
	}
