 ...
 *
 */
public class AsignacionLogica extends AbstractExpresion implements Sentencia {

	private Expresion op1, op2;
	private String operador;

	public AsignacionLogica(int i, int j, Object op1, Object operador, Object op2) {
		super(i, j);
	...
	public AsignacionLogica(int i, int j, Expresion op1, String operador, Expresion op2) {
		super(i, j);
		this.op1 = op1;
		this.op2 = op2;
